...
import 'package:video_sample/presentation/home/home_state.dart';
...
class HomeViewModel with ChangeNotifier {
  ...
  Future _setMovie(Movie movie) async {
    _videoPlayerController = VideoPlayerController.network(movie.url);
  ...
  Future<void> setSelectMovie(Movie movie) async {
    _state = state.copyWith(
      selectedMovie: movie,
    );
